...
<div class="py-0">
  <div class="container">
    <div class="row">
      <div class="col-md-12"><a class="btn btn-primary" href="<?php echo base_url('tags/add_tag'); ?>"><i class="fa fa-plus"></i>&ensp;Tambahkan Tag</a></div>
    </div>
  </div>
</div>
<?php } ?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url('tags/edit_tag/' . $c['ID_TAGS']) ?>" class="btn btn-sm btn-info"><i class="fa fa-lg fa-pencil"></i>&nbsp;Edit</a>
                  <a href="#" data-toggle="modal" data-target="#ModalDelete" data-id="<?= $c['ID_TAGS']; ?>" data-title="<?= $c['TAGS']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-lg fa-trash"></i>&nbsp;Hapus</a>
                </td>
                <?php } ?>
              </tr>
              <?php $i++; } ?>
